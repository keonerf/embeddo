      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Interested in joining our society or collaborating on projects? We'd
              ...
              <CardContent className="p-6 text-center">
                ...
                <div className="flex justify-center space-x-4">
                  <div className="flex justify-center space-x-6">
                    ...
                    >
                      <Instagram className="h-6 w-6 hover:drop-shadow-[0_0_6px_rgba(255,100,200,0.6)]" />
                    </a>
                    <a
                    ...
                    >
                      <Linkedin className="h-6 w-6 hover:drop-shadow-[0_0_6px_rgba(100,150,255,0.6)]" />
                    </a>
                    <a
                    ...
                    >
                      <Github className="h-6 w-6 hover:drop-shadow-[0_0_6px_rgba(0,255,150,0.6)]" />
                    </a>
                  </div>
                </div>
              </CardContent>
